...
namespace Tutorial501
{
    ...
    public class SeamlessNoiseGeneratorEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            // RGB通道设置
            showChannelSettings =
                EditorGUILayout.Foldout(showChannelSettings, "RGB通道设置", true, EditorStyles.foldoutHeader);
            ...
            // 纹理设置
            showTextureSettings =
                EditorGUILayout.Foldout(showTextureSettings, "纹理设置", true, EditorStyles.foldoutHeader);
