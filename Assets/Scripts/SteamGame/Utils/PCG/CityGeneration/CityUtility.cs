...
namespace CityGenerator
{
    public static class CityUtility
    {
        ...
        public static StepMoveDirectionType
            TurnRight(this StepMoveDirectionType dir) // find right direction of current direction
            => dir switch
            {
        ...
        public static StepMoveDirectionType
            TurnLeft(this StepMoveDirectionType dir) // find left direction of current direction
            => dir switch
            {
        ...
        public static Vector3 ApplyOffset(this Vector3 position, float offset, StepMoveDirectionType dir,
        ...
        public static bool IsNearRoad(this CityMark[,] marks, DirectionType dir, int x, int y) // check front and back
        {
            ...
            bool IsStepOnRoad(int x, int y) => marks.IsStepOn((x, y), CityObjectType.MajorRoad,
                CityObjectType.MajorJunction, CityObjectType.MinorRoad, CityObjectType.Junction);
        }
        ...
        public static bool IsStepOnRoad(this CityMark[,] marks, (int, int) step) => marks.IsStepOn(step,
            CityObjectType.MajorRoad, CityObjectType.MajorJunction, CityObjectType.Junction, CityObjectType.MinorRoad);
    ...
    public enum StepMoveDirectionType
    {
        Left,
        Right,
        Front,
