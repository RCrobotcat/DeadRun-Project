...
public class OutlineNormalsCalculator : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        for (int t = 0; t < numTriangles; t++)
        {
            ...
            ComputeNormalAndWeights(vertices[v1Index], vertices[v2Index], vertices[v3Index], out Vector3 normal,
                out Vector3 weights);
    ...
    private void AddWeightedNormal(Vector3 weightedNormal, int vertexIndex, int[] cvIndices,
        List<CospatialVertex> cvRegistry)
    {
